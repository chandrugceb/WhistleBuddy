...
import com.whistlebuddy.chand.whistlebuddy.MainActivity;
import com.whistlebuddy.chand.whistlebuddy.MapActivity;
import com.whistlebuddy.chand.whistlebuddy.R;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
   ...
   /**
    ...
    private void sendNotification(String messageBody, String SenderId) {
        ...
        GoogleSignInAccount account = GoogleSignIn.getLastSignedInAccount(MyFirebaseMessagingService.this);
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentText("Hi "+account.getDisplayName()+ ", " + messageBody)
                        .setAutoCancel(true)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("16",
